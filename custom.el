...
(custom-set-variables
 ...
 '(package-selected-packages
   '(avy corfu dape eldoc-box embark-consult envrc ess fish-mode
         gruvbox-theme jupyter ligature magit marginalia markdown-mode
         nerd-icons-dired nix-mode orderless pet sml-mode treesit-auto
         vertico web-mode)))
(custom-set-faces
